...
lexicon $LEXICON_OPTIONS $LEXICON_PROVIDER $LEXICON_PROVIDER_OPTIONS delete $DELEGATED_DOMAIN TXT --name="_acme-challenge.$CERTBOT_DOMAIN.$DELEGATED_SUBDOMAIN." --content="$CERTBOT_VALIDATION"
else
